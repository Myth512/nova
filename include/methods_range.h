...
/* Command-line: gperf gperf/methods_range.txt  */
...
#line 1 "gperf/methods_range.txt"

#include <string.h>
#include "py_range.h"
#include "value.h"
#line 7 "gperf/methods_range.txt"
...
in_range_set (register const char *str, register size_t len)
{
  static const struct StaticAttribute wordlist[] =
    {
      {""}, {""}, {""}, {""},
#line 16 "gperf/methods_range.txt"
      {"stop", PyRange_Stop, false},
#line 14 "gperf/methods_range.txt"
      {"start", PyRange_Start, false},
      {""}, {""}, {""},
#line 15 "gperf/methods_range.txt"
      {"step", PyRange_Step, false},
      {""}, {""}, {""}, {""},
#line 17 "gperf/methods_range.txt"
