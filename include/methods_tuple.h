...
/* Command-line: gperf gperf/methods_tuple.txt  */
...
#line 1 "gperf/methods_tuple.txt"

#include <string.h>
#include "py_tuple.h"
#include "value.h"
#line 7 "gperf/methods_tuple.txt"
...
in_tuple_set (register const char *str, register size_t len)
{
  static const struct StaticAttribute wordlist[] =
    {
#line 15 "gperf/methods_tuple.txt"
      {"index", PyTuple_Index, true},
#line 14 "gperf/methods_tuple.txt"
